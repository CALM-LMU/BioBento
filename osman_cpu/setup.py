...
setuptools.setup(
    name='YeastMate',
    version='20201214093219_9D70A3',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - YeastMate:20201214093219_9D70A3
...
""",
    ...
    package_data={
        'YeastMate': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'YeastMate=YeastMate:cli',
        ],
    }
)
